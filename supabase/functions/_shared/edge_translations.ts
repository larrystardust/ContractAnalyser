export const edgeTranslations = {
  en: {
    ...
    notification_message_ocr_failed": "OCR processing for '{{contractName}}' failed: {{errorMessage}}",
  ...
  es: {
    ...
    notification_message_ocr_failed": "El procesamiento OCR para '{{contractName}}' falló: {{errorMessage}}",
  ...
  fr: {
    ...
    notification_message_ocr_failed": "Le traitement OCR pour '{{contractName}}' a échoué : {{errorMessage}}",
  ...
  ar: {
    ...
    notification_message_ocr_failed": "فشلت معالجة التعرف الضوئي على الحروف (OCR) للعقد '{{contractName}}': {{errorMessage}}",
