export const edgeTranslations = {
  ...
  es: {
    ...
    category_financial: "Financiero",
    category_indemnification: "Indemnización",
    category_consumer_protection: "Protección al Consumidor",
    category_payment_terms: "Condiciones de Pago",
    category_legal_compliance: "Cumplimiento Legal",
    category_force_majeure: "Fuerza Mayor",
    category_performance_standards: "Estándares de Rendimiento",
    category_discrimination: "Discriminación",
    category_legal_enforceability: "Exigibilidad legal",
  ...
  fr: {
    ...
    category_indemnification: "Indemnisation",
    category_consumer_protection: "Protection du Consommateur",
    category_payment_terms: "Conditions de Paiement",
    category_legal_compliance: "Conformité Légale",
    category_force_majeure: "Force Majeure",
    category_performance_standards: "Normes de Performance",
    category_discrimination: "Discrimination",
    category_legal_enforceability: "Force exécutoire légale",
    category_pricing: "Tarification",
  ...
  ar: {
    ...
    category_indemnification: "تعويض",
    category_consumer_protection: "حماية المستهلك",
    category_payment_terms: "شروط الدفع",
    category_legal_compliance: "الامتثال القانوني",
    category_force_majeure: "القوة القاهرة",
    category_performance_standards: "معايير الأداء",
    category_discrimination: "التمييز",
    category_legal_enforceability: "القابلية للتنفيذ القانوني",
