...
export const stripeProducts: StripeProduct[] = [
  ...
  // ADDED: New Advanced Subscription Plans - Professional Use (Advanced)
  {
    ...
    pricing: {
      monthly: {
        priceId: 'price_1SM2wMCgxsPALRL7wvpsJY3y', // Placeholder, replace with actual Stripe Price ID
        price: 49.99,
        interval: 'month',
      },
      yearly: {
        priceId: 'price_1SM33HCgxsPALRL7DrDkBWEN', // Placeholder, replace with actual Stripe Price ID
        price: 499.90,
        interval: 'year',
      },
    },
  ...
  // ADDED: New Advanced Subscription Plans - Enterprise Use (Advanced)
  {
    ...
    pricing: {
      monthly: {
        priceId: 'price_1SM2zDCgxsPALRL7MLy2vlQO', // Placeholder, replace with actual Stripe Price ID
        price: 499.99,
        interval: 'month',
      },
      yearly: {
        priceId: 'price_1SM38RCgxsPALRL7Rd0MXrXn', // Placeholder, replace with actual Stripe Price ID
        price: 4999.90,
        interval: 'year',
      },
    },
