      ...
      <body>
          <div class="container">
              ...
              <div class="section artifact-section">
                  ...
                  <p><a href="${redlinedArtifactViewerUrl}" style="color: #0056b3; font-weight: bold; text-decoration: underline;">${getTranslatedMessage('view_artifact', outputLanguage)}</a></p>
              </div>
              ` : ''}
