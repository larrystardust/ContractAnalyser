      ...
      <body>
          <div class="container">
              ...
              <div class="section artifact-section">
                  ...
                  <p><a href="https://contractanalyser.com/public-report-view?${encodeURIComponent(finalAnalysisResult.redlined_clause_artifact_path)}&lang=${outputLanguage}" target="_blank" style="color: #0056b3; font-weight: bold; text-decoration: underline;">${getTranslatedMessage('view_artifact', outputLanguage)}</a></p>
              </div>
              ` : ''}
