      ...
      <body>
          <div class="container">
              ...
              <div class="section artifact-section">
                  ...
                  <p><a href="${appBaseUrl}/public-report-view?artifactPath=${encodeURIComponent(finalAnalysisResult.redlined_clause_artifact_path)}" target="_blank" style="color: #0056b3; font-weight: bold; text-decoration;">${getTranslatedMessage('view_artifact', outputLanguage)}</a></p> 
              </div>
              ` : ''}
