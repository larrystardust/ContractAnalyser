          ...
          {!hasAvailableSingleUse() && (!subscription || currentFileCount >= maxAllowedFiles) && (
            <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4">
              {subscription && currentFileCount >= maxAllowedFiles ? (
                ...
                <p>
                  You do not have an available single-use credit or a subscription plan. Please purchase one from the <a href="/pricing" className="font-medium underline">Pricing page</a> to upload a contract.
                </p>
              )}
            </div>
          )}
