    ...
    <div className="overflow-x-auto bg-white shadow-md rounded-lg">
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-gray-50">
          <tr>{/* MODIFIED: Wrap content in fragment and ensure no whitespace around <tr> and <> */}
            <>
              {columns.map((column) => (
                <th
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {data.map((item) => (
            <tr key={item.id}>{/* MODIFIED: Wrap content in fragment and ensure no whitespace around <tr> and <> */}
              <>
                {columns.map((column) => (
