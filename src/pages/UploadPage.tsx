...
const UploadPage: React.FC = () => {
  ...
  const handleDoneCapturing = () => {
    ...
    // REMOVED: Logic to show naming modal from UploadPage
  };
  ...
  // REMOVED: handleTriggerUpload and useEffect for triggerUpload
  ...
  return (
    <div className="container mx-auto px-4 py-6 mt-16">
      ...
      {/* REMOVED: Naming Modal for Scanned Contracts from UploadPage */}
    </div>
  );
};
