...
const ReportsPage: React.FC = () => {
  ...
  const { contracts, loadingContracts } = useContracts(); // Keep loadingContracts for real data
    ...
    <div className="container mx-auto px-4 py-6 mt-16">
      ...
      {contracts.length === 0 && !isPayingCustomer && ( // MODIFIED: Condition for showing sample data banner
        <div className="bg-blue-50 border-l-4 border-blue-500 text-blue-700 p-4 mb-6" role="alert">
          ...
          <p className="text-sm">These reports are based on sample data. Upgrade to see analytics for your own contracts!</p>
      ...
      {contracts.length === 0 && isPayingCustomer && ( // ADDED: Empty state for paying users
        <Card>
          <CardBody className="text-center py-8">
            ...
            <p className="text-gray-500 mt-2">Upload a contract to see your reports!</p>
      ...
      {contractsToDisplay.length > 0 && ( // Only show stats if there's data to display
        <>
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Findings by Risk Level (All Completed Contracts)</h2>
